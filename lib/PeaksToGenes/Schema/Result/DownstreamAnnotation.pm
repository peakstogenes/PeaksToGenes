use utf8;
package PeaksToGenes::Schema::Result::DownstreamAnnotation;
...
=head1 TABLE: C<downstream_annotation>

=cut

__PACKAGE__->table("downstream_annotation");
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:2SP8A2FWCtOqruqXtdLjWw
