use utf8;
package PeaksToGenes::Schema::Result::GeneBodyAnnotation;
...
=head1 TABLE: C<gene_body_annotation>

=cut

__PACKAGE__->table("gene_body_annotation");
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:lgcSw+bq702c6OYwz7PYjQ
