use utf8;
package PeaksToGenes::Schema::Result::TranscriptAnnotation;
...
=head1 TABLE: C<transcript_annotation>

=cut

__PACKAGE__->table("transcript_annotation");
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:TpLM3yNP9x6sXccWIKy9eA
